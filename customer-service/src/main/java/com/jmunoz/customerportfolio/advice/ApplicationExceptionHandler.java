package com.jmunoz.customerportfolio.advice;

import com.jmunoz.customerportfolio.exceptions.CustomerNotFoundException;
import com.jmunoz.customerportfolio.exceptions.InsufficientBalanceException;
import com.jmunoz.customerportfolio.exceptions.InsufficientSharesException;
...
public class ApplicationExceptionHandler {
    ...
    public ProblemDetail handleException(CustomerNotFoundException ex) {
        return build(HttpStatus.NOT_FOUND, ex, problem -> {
            // Esta página no existe, es solo para fines demostrativos.
